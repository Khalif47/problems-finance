...
# connect.commit()
# c.execute('''CREATE TABLE stocks (id INTEGER NOT NULL, symbol TEXT(10) NOT NULL, name TEXT NOT NULL, share INTEGER NOT NULL,
#   price DECIMAL(15,2) NOT NULL, total DECIMAL(15,2) NOT NULL);''')
# connect.commit()
# c.execute("CREATE UNIQUE INDEX uq_stocks ON stocks(id, symbol);")
# connect.commit()